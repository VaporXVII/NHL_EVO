with src as (
    ...
    where 1 = 1
        ...
        and (
            a.game_date >= date_sub(from_utc_timestamp(current_timestamp(), 'America/Chicago')::date, 2) 
            or 
            a.insert_dte::date >= date_sub(from_utc_timestamp(current_timestamp(), 'America/Chicago')::date, 2)
            )
)
...
using src s 
    ...
    and t.game_date between 
        ...
        and 
        from_utc_timstamp(current_timestamp(), 'America/Chicago')::date 
